...
extern int triggerbotDelay;         // <--- NUEVO: delay del triggerbot
		...
		if (ImGui::BeginChild("##main_split"))
		{
			...
			ImGui::BeginChild("##tab_content", ImVec2(0, size.y), true);
			{
				if (active_tab == Tab::PLAYER)
				{
					...
					// ============================================================
					//  AIMBOT - SECCIÓN AGREGADA (CON TRIGGERBOT Y DELAY)
					// ============================================================
					ImGui::Spacing();
					ImGui::Text("Aimbot");
					ImGui::Separator();
					...
					ImGui::BeginGroup();
					{
						...
						ImGui::SliderFloat("FOV (px)", &aimbotFOV, 20.0f, 500.0f, "%.0f");
						ImGui::SliderFloat("Smoothness", &aimbotSmoothness, 1.0f, 20.0f, "%.1f");

						// ============================================================
						//  TRIGGERBOT - CONTROLES AGREGADOS
						// ============================================================
						ImGui::Checkbox("Triggerbot", &triggerbotEnabled);
						ImGui::SliderInt("Trigger Delay (ms)", &triggerbotDelay, 1, 500, "%d");
					}
					ImGui::EndGroup();
					// ============================================================
				}
